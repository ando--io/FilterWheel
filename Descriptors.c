...
const USB_Descriptor_HIDReport_Datatype_t PROGMEM GenericReport[] =
{
	 ...
	 */
	HID_RI_USAGE_PAGE(16, (0xFF00 | 0x00)),
	HID_RI_USAGE(8, 0x01),
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ManufacturerString = USB_STRING_DESCRIPTOR(L"Starlight XPress");

/** Product descriptor string. This is a Unicode string containing the product's details in human readable form,
 *  and is read out upon request by the host when the appropriate string ID is requested, listed in the Device
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ProductString = USB_STRING_DESCRIPTOR(L"SX Filter Wheel");
